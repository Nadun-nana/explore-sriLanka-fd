          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/create">
              <Button
                variant="default"
                size="default"
                className="bg-primary-500 hover:bg-primary-600 text-white mr-2"
              >
                Share Experience
              </Button>
            </Link>
            <Link to="/login">
              <Button
                variant="outline"
                size="default"
                className={`border ${isScrolled ? 'border-primary-500 text-primary-600' : 'border-white text-white'} hover:bg-primary-500 hover:text-white`}
              >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg rounded-b-2xl mt-2 animate-slide-down">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              to="/login"
              className="block px-3 py-2 mt-2 rounded-md text-base font-medium border border-primary-500 text-primary-600 hover:bg-primary-500 hover:text-white flex items-center justify-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <LogIn className="h-4 w-4 mr-2" />
              Login
